"""
Django settings for salis_43427 project.
...
WSGI_APPLICATION = 'salis_43427.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "salis_43427 API",
    "DESCRIPTION": "API documentation for salis_43427 App",
    "VERSION": "v1",
}
